      ...
      {Array.from({ length: total }, (_, i) => (
        <Fragment key={i}>
          <img
            src={saveTracker}
            alt="Save Tracker"
            className="save-throw-tracker__save-btn-image"
          />
          <span
            className={`save-throw-tracker__pip ${i < count ? "is-filled" : ""}`}
          />
        </Fragment>
      ))}
    </span>
...
export default function SaveThrowTracker({ instanceId }) {
  ...
  if (initiativeInstances.length === 0) {
    return (
      <div className="save-throw-tracker">
        <p className="save-throw-tracker__empty">
          {t("saveThrowTracker.emptyNoInitiative")}
        </p>
      </div>
    );
  }
  ...
  const downed = combatants.filter(
    (c) =>
      (c.type === "player" || c.type === "npc") && c.hp && c.hp.current <= 0,
  );
  ...
  return (
    <div className="save-throw-tracker">
      ...
      <ul className="save-throw-tracker__list">
        {downed.length === 0 && (
          <li className="save-throw-tracker__empty">
            {t("saveThrowTracker.emptyNoDowned")}
          </li>
        )}
            ...
            <li key={combatant.id} className="save-throw-tracker__row">
              <div className="save-throw-tracker__combatant-image-container">
                {combatant.image ? (
                  ...
                  <div
                    className="save-throw-tracker__combatant-image-placeholder"
              ...
              {combatant.isDead ? (
                <div className="save-throw-tracker__dead">
                  ...
                  <button
                    type="button"
                    onClick={() => resetDeathSaves(linkedId, combatant.id)}
                  >
                ...
                <div className="save-throw-tracker__saves">
                  <div className="save-throw-tracker__save-row">
                    ...
                    <button
                      ...
                      onClick={() =>
                        recordDeathSave(linkedId, combatant.id, "successes")
                      }
                    >
                  ...
                  <div className="save-throw-tracker__save-row">
                    ...
                    <button
                      ...
                      onClick={() =>
                        recordDeathSave(linkedId, combatant.id, "failures")
                      }
                    >
